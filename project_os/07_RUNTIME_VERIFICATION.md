...
| **Storage & MinIO S3** | **VERIFIED** | `POST /storage/upload-url`, `/confirm` verified: Presigned S3 upload URL flow & `test_storage_search_jobs.py` integration tests. | PASS (10/10) |
